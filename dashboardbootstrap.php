...
<head>
    ...
    <link href="dashboardb.css" rel="stylesheet">
...
<body> <svg xmlns="http://www.w3.org/2000/svg" class="d-none">
            ...
            <div class="sidebar border border-right col-md-3 col-lg-2 p-0 bg-body-tertiary">
                <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu"
                    ...
                    <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
                        ...
                        <hr class="my-3">
                        <ul class="nav flex-column mb-auto">
                            <li class="nav-item"> <a class="nav-link d-flex align-items-center gap-2" href="setting.php"> <svg
                                        class="bi" aria-hidden="true">
    ...
    <script src="dashboardbootstrap.js" class="astro-vvvwv3sm"></script>
</body>
